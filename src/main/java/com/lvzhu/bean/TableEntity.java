...
public class TableEntity {
    ...
    public String toString() {
        return "TableEntity{" + "tableName='" + tableName + '\'' + ", comments='" + comments + '\'' + ", columns=" + columns + ", className='" + className + '\'' + ", classname='" + classname + '\'' + ", pk=" + pk + ", uniqueKeyMap=" + uniqueKeyMap + '}';
    }
}
